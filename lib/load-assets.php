...
function bsg_enqueue_css_js() {
    ...
    wp_register_style( 'bsg-combined-css', plugins_url('css/style.min.css', __DIR__), array(), '3.3.5' );

    // wp_register_script( $handle, $src, $deps, $ver, $in_footer );
    wp_register_script( 'bsg-combined-js', plugins_url('js/javascript.min.js', __DIR__), array('jquery'), '3.3.5', true );
